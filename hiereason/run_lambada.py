...
from hiereason.lambada import generate_abductive_proof

from utils import HiereasonContext
from utils.config import load_config, set_logger
...
def main(args):
    ...
    set_logger("lambada", dataset=args.dataset, model=args.model)
    ...
    dataset = HiereasonContext("lambada", config, dataset)
    logging.info("==============================\n")
    logging.info("PROMPT:")
    ...
    with get_openai_callback() as cb:
        ...
        # result_dir = f"logs/lambada_{startdate}_{args.dataset}_result.json"
